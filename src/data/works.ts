...
export const extraWorks: Work[] = [
  ...
  { id: "yt-dsm-firmenich-running", slug: "dsm-firmenich-running", title: "디에스엠 퍼메니쉬 러닝팀", client: "DSM Firmenich", category: "b2b", categoryLabel: "B2B", year: "2026", duration: "", period: "", role: "기획 / 제작", ...yt("FVwlIx4pD3o"), thumbnailUrl: "/works/dsm-firmenich-running.webp", description: "기업의 러닝팀 활동을 생동감 있게 담은 B2B 영상.", tags: ["B2B", "기업"], featured: false, size: "medium" },
  { id: "yt-kkomo-triceratops", slug: "kkomo-triceratops", title: "꼬모탐험대 '트리케라톱스'", client: "꼬모", category: "promo", categoryLabel: "콘텐츠", year: "2018", duration: "", period: "", role: "기획 / 제작", ...yt("i-oU0PHGMKI"), thumbnailUrl: "/works/kkomo-triceratops.webp", description: "아이들의 호기심을 자극하는 공룡 탐험 키즈 콘텐츠.", tags: ["키즈", "콘텐츠"], featured: false, size: "medium" },
  { id: "yt-kkomo-mosasaurus", slug: "kkomo-mosasaurus", title: "꼬모탐험대 '모사사우루스'", client: "꼬모", category: "promo", categoryLabel: "콘텐츠", year: "2019", duration: "", period: "", role: "기획 / 제작", ...yt("LigtDTkxbbQ"), thumbnailUrl: "/works/kkomo-mosasaurus.webp", description: "아이들의 호기심을 자극하는 공룡 탐험 키즈 콘텐츠.", tags: ["키즈", "콘텐츠"], featured: false, size: "medium" },
  { id: "yt-bongmyeong-woman", slug: "bongmyeong-coffee-woman", title: "봉명동네커피 '여자편'", client: "봉명동네커피", category: "promo", categoryLabel: "광고·홍보", year: "2026", duration: "", period: "", role: "기획 / 제작", ...yt("K_KEydsrN-c"), thumbnailUrl: "/works/bongmyeong-coffee-woman.webp", description: "동네 커피 브랜드의 감성을 담은 광고 영상.", tags: ["광고", "브랜드"], featured: false, size: "medium" },
  { id: "yt-bongmyeong-man", slug: "bongmyeong-coffee-man", title: "봉명동네커피 '남자편'", client: "봉명동네커피", category: "promo", categoryLabel: "광고·홍보", year: "2026", duration: "", period: "", role: "기획 / 제작", ...yt("XMMPJ1ictw8"), thumbnailUrl: "/works/bongmyeong-coffee-man.webp", description: "동네 커피 브랜드의 감성을 담은 광고 영상.", tags: ["광고", "브랜드"], featured: false, size: "medium" },
  { id: "yt-kt-wis-ep01", slug: "kt-wis-shorts-ep01", title: "KT WIS 쇼츠 인터뷰 ep.01", client: "KT", category: "b2b", categoryLabel: "B2B", year: "2026", duration: "", period: "", role: "기획 / 제작", ...yt("5zSuwahbB98"), thumbnailUrl: "/works/kt-wis-shorts-ep01.webp", description: "전시회 현장을 담은 KT B2B 쇼츠 인터뷰 시리즈.", tags: ["B2B", "숏폼", "인터뷰"], featured: false, size: "medium" },
  { id: "yt-kt-wis-ep03", slug: "kt-wis-shorts-ep03", title: "KT WIS 쇼츠 인터뷰 ep.03", client: "KT", category: "b2b", categoryLabel: "B2B", year: "2026", duration: "", period: "", role: "기획 / 제작", ...yt("Hi0B7J5WDHc"), thumbnailUrl: "/works/kt-wis-shorts-ep03.webp", description: "전시회 현장을 담은 KT B2B 쇼츠 인터뷰 시리즈.", tags: ["B2B", "숏폼", "인터뷰"], featured: false, size: "medium" },
  { id: "yt-lashevan-ceo-30s", slug: "lashevan-ceo-30s", title: "LASHEVAN 'CEO편' 30s", client: "LASHEVAN", category: "promo", categoryLabel: "광고·홍보", year: "2026", duration: "30s", period: "", role: "기획 / 제작", ...yt("P7XxbsVjA_c"), thumbnailUrl: "/works/lashevan-ceo-30s.webp", description: "CEO의 신뢰감과 AI 3D 제품을 결합한 라쉬반 메인 광고.", tags: ["광고", "AI 3D", "브랜드필름"], featured: false, size: "medium" },
  { id: "yt-lashevan-material", slug: "lashevan-material", title: "LASHEVAN '소재편'", client: "LASHEVAN", category: "promo", categoryLabel: "광고·홍보", year: "2026", duration: "", period: "", role: "기획 / 제작", ...yt("Rnt-GjAzCBM"), thumbnailUrl: "/works/lashevan-material.webp", description: "친환경 소재의 질감을 강조한 라쉬반 제품 광고.", tags: ["광고", "브랜드필름"], featured: false, size: "medium" },
  { id: "yt-lashevan-cut", slug: "lashevan-cut", title: "LASHEVAN '재단편'", client: "LASHEVAN", category: "promo", categoryLabel: "광고·홍보", year: "2026", duration: "", period: "", role: "기획 / 제작", ...yt("4JuXYnr_fZI"), thumbnailUrl: "/works/lashevan-cut.webp", description: "정교한 재단과 핏을 강조한 라쉬반 제품 광고.", tags: ["광고", "브랜드필름"], featured: false, size: "medium" },
  { id: "yt-gangdong-5030", slug: "gangdong-safe-speed-5030", title: "서울강동경찰서 '안전속도 5030'", client: "서울강동경찰서", category: "public", categoryLabel: "공공·기관", year: "2022", duration: "", period: "", role: "기획 / 제작", ...yt("iDxepX0G1YM"), thumbnailUrl: "/works/gangdong-safe-speed-5030.webp", description: "교통안전 정책을 알기 쉽게 전달한 공공 캠페인 영상.", tags: ["공공", "교통안전", "캠페인"], featured: false, size: "medium" },
];
