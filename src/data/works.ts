...
export const works: Work[] = [
  {
    id: "yt-macrogen-ai-myeonghwa",
    slug: "macrogen-ai-myeonghwa-content",
    title: "마크로젠 'AI 명화 콘텐츠'",
    ...
    role: "기획 / 제작",
    ...yt("C-GtTwa2yvM"),
    thumbnailUrl: "/works/macrogen-ai-myeonghwa.webp",
    description:
      "AI로 재해석한 명화로 브랜드의 메시지를 전한 콘텐츠. 예술적 감성과 AI 기술을 결합했습니다.",
    tags: ["AI", "브랜드 콘텐츠", "명화"],
    featured: false,
    size: "medium",
  },
  {
    id: "yt-coding-ai-news-ep02",
    slug: "coding-ai-news-ep02",
    title: "'코딩 AI 뉴스' ep.02",
    client: "코딩",
    category: "ai",
    categoryLabel: "AI",
    year: "2026",
    ...
    role: "기획 / 제작",
    ...yt("lt-6FvhoVFQ"),
    thumbnailUrl: "/works/coding-ai-news-ep02.webp",
    description:
      "AI 기반으로 제작한 뉴스형 콘텐츠 시리즈. 정보 전달과 AI 비주얼을 결합했습니다.",
    tags: ["AI", "뉴스 콘텐츠", "시리즈"],
    featured: false,
    size: "medium",
  },
  {
    id: "yt-kt-enterprise-quantum",
    slug: "kt-enterprise-quantum",
    title: "KT Enterprise '양자암호통신'",
    ...
    role: "기획 / 제작",
    ...yt("BFzKHeMhY_0"),
    thumbnailUrl: "/works/kt-quantum-network.webp",
    description:
      "복잡한 양자암호통신 기술을 그래픽과 모션으로 명료하게 풀어낸 B2B 영상.",
    tags: ["B2B", "양자암호통신", "모션그래픽"],
    featured: false,
    size: "medium",
  },
  {
